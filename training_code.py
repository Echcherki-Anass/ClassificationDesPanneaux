...
def myModel():
    ...
    size_of_Filter2=(3,3)
    size_of_pool=(2,2)  
    no_Of_Nodes = 500   # Nombre de noeuds de couche cachée
    model= Sequential()
    ...
    model.add(Dropout(0.5)) 
    model.add(Dense(noOfClasses,activation='softmax')) # Couche de sortie
    # COMPILE MODEL
...
# Sauvegarde du modèle comme objet Pickle
